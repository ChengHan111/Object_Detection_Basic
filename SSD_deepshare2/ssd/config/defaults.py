...
_C.MODEL.THRESHOLD = 0.5 # iou交并比
_C.MODEL.NUM_CLASSES = 21 # 20+1 for VOC
# 困难样本比例
...
# -----------------------------------------------------------------------------
_C.MODEL.PRIORS = CN()
_C.MODEL.PRIORS.FEATURE_MAPS = [38, 19, 10, 5, 3, 1] # 6个feature map的大小38x38...
_C.MODEL.PRIORS.STRIDES = [8, 16, 32, 64, 100, 300] #用来做映射回去 8x38=304 16x19=304
...
_C.SOLVER.WARMUP_FACTOR = 1.0 / 3 # 学习率逐渐增加
